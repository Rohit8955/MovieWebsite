...
<div className='flex flex-col h-[470px] gap-8 relative rounded-md '>
    <div className='min-h-[350px] max-h-[350px] max-w-[237px] min-w-[237px] overflow-hidden rounded-md hover:cursor-pointer relative '>
        {/* <Img src={props.path}/> */}
        <img className='h-[350px] w-full rounded-md img ' src={props.path} alt="" />
