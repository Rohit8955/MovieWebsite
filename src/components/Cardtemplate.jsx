...
<div className='flex flex-col h-[270px] md:h-[470px] gap-3 md:gap-8 relative rounded-md '>
    <div className=' min-h-[190px] min-w-[120px] md:min-h-[350px]   md:min-w-[237px] overflow-hidden rounded-md hover:cursor-pointer relative '>
        {/* <Img src={props.path}/> */}
    ...
    <div className=' absolute w-[30px] md:w-[50px] bottom-[70px] left-3 md:left-3 md:bottom-[96px]'><CircularProgressbar  maxValue={10}   value={props.rating} text={newrate} className=' p-[2px] rounded-[50%] font-[700] bg-white'
