        ...
        <div className='mt-[100px]'>
          
          {
            ...
            (
              ...
              <InfiniteScroll dataLength={data?.results?.length || []} next={fetchNextPageData} hasMore={pagenum<=data?.total_pages} loader={<Spinner/>} className='grid w-full md:w-[1240px] grid-cols-3 gap-x-1 md:gap-x-[7px]  md:grid-cols-5'>
                {
