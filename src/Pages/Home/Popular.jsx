    ...
    <div>
        ...
        <div className='flex justify-center'>
            <div className='flex justify-between w-[1000px]'>
                <h1 className='text-white text-[28px] items-center]'>Popular</h1>
        ...
        <div className='grid place-items-center'>
                ...
                <div className=' flex gap-4 w-[1000px] overflow-x-auto overflow-y-hidden '>
                    ...
                    return <Cardtemplate key={idx} mediatype={tab} id={elem.id} genres={elem?.genre_ids.slice(0,2)} path={elem?.poster_path!==null?path:noposterimg} rating={elem?.vote_average} name={elem?.name} title={elem?.title} tvdate={elem?.first_air_date} date={elem?.release_date}/>
                    })
                    }
                </div>
            </div>
